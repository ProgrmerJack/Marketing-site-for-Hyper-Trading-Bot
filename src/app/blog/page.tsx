      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10">
          {backgroundsEnabled && hydrated ? (
            <AnimatedBackground
              variant="beams"
              colors={["rgba(59, 130, 246, 0.4)", "rgba(236, 72, 153, 0.3)", "rgba(16, 185, 129, 0.25)"]}
              speed="32s"
              opacity={0.6}
            />
          ) : (
      ...
      <section className="relative overflow-hidden py-24 md:py-32">
        ...
        <div className="pointer-events-none absolute inset-0 -z-10">
          {backgroundsEnabled && hydrated ? (
            <AnimatedBackground
              variant="liquid"
              colors={["rgba(236, 72, 153, 0.3)", "rgba(139, 92, 246, 0.25)", "rgba(59, 130, 246, 0.2)"]}
              speed="30s"
              opacity={0.6}
            />
          ) : (
            <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(236,72,153,0.1),transparent_70%)]" />
          )}
          <div className="absolute inset-0 bg-gradient-to-b from-white/60 via-transparent to-white/60 dark:from-slate-950/60 dark:to-slate-950/60" />
        </div>
