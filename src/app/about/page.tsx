      ...
      <section className="relative isolate min-h-[90vh] overflow-hidden bg-transparent py-20 md:py-32">
        ...
        <Container className="relative z-10">
          <div className="mx-auto max-w-4xl space-y-8 text-center">
            ...
            >
              <ClickSpark sparkColor="rgba(34, 211, 238, 0.8)" sparkCount={14} sparkRadius={36} sparkSize={11}>
          ...
          <div className="mx-auto max-w-7xl space-y-16">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {founderStory.story.map((section, index) => (
                ...
                >
                  <SpotlightCard
                    className="h-full rounded-3xl border border-slate-200/60 bg-[rgb(var(--card))/0.85] p-8 shadow-lg backdrop-blur-md transition-all duration-300 hover:shadow-xl dark:border-slate-700/60 dark:bg-slate-900/80"
                    spotlightColor="rgba(59, 130, 246, 0.2)"
                  >
                    <div className="mb-4 text-xs font-bold uppercase tracking-widest text-blue-600 dark:text-blue-400">
                      {String(index + 1).padStart(2, "0")}
                    </div>
                    <h4 className="mb-4 text-xl font-bold text-slate-900 dark:text-white">{section.title}</h4>
                    <p className="text-sm leading-relaxed text-slate-600 dark:text-slate-300">{section.content}</p>
                  </SpotlightCard>
                </motion.div>
              ))}
            </div>
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
              {founderStory.principles.map((principle, index) => {
                ...
                return (
                  ...
                  >
                    <SpotlightCard
                      className="group relative h-full overflow-hidden rounded-3xl border border-slate-200/60 bg-[rgb(var(--card))/0.85] p-8 shadow-lg backdrop-blur-md transition-all duration-300 hover:shadow-xl dark:border-slate-700/60 dark:bg-slate-900/80"
                      spotlightColor="rgba(59, 130, 246, 0.2)"
                    >
          ...
          <div className="mx-auto max-w-7xl space-y-16">
            ...
            <div className="grid gap-8 md:grid-cols-2">
              {leadership.map((person, index) => (
                ...
                >
                  <SpotlightCard
                    className="h-full rounded-3xl border border-border bg-card p-8 shadow-lg transition-all duration-300 hover:shadow-xl"
