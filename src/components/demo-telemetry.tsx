...
export function DemoTelemetry() {
  ...
  return (
    <section
      aria-live="polite"
      className="flex flex-col gap-5 rounded-3xl border border-[color:var(--color-line-muted)]/50 bg-white/80 p-6 text-sm text-black/70 dark:bg-black/50 dark:text-white/70"
    >
