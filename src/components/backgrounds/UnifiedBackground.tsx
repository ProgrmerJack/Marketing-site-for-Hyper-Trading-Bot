...
export function UnifiedBackground() {
  ...
  if (!backgroundsEnabled || !hydrated) {
    ...
    return (
      <div className="pointer-events-none fixed inset-0 z-0 opacity-30 dark:opacity-20" data-testid="hyperspeed-fallback">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,rgba(59,130,246,0.15),rgba(56,189,248,0.1),transparent_70%)] dark:bg-[radial-gradient(ellipse_at_top,rgba(29,78,216,0.12),rgba(56,189,248,0.08),transparent_70%)]" />
  ...
  return (
    ...
    >
      ...
      {/* Gradient overlay for better content visibility and cinematic vignette */}
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-white/60 to-white/80 dark:from-transparent dark:via-slate-950/60 dark:to-slate-900/80" />
      <div className="pointer-events-none absolute inset-0 -z-20 bg-[radial-gradient(ellipse_at_top,rgba(0,0,0,0.05),transparent_40%)] dark:bg-[radial-gradient(ellipse_at_top,rgba(0,0,0,0.45),transparent_35%)]" />
    </div>
  );
}
